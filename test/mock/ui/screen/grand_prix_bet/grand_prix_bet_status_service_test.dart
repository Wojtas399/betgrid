...
void main() {
  ...
  group(
    'selectStatusBasedOnPoints',
    () {
      test(
        'should return pending status if points are null',
        () {
      ...
      test(
        'should return loss status if points are equal to 0',
        () {
      ...
      test(
        'should return win status if points are higher than 0',
        () {
      ...
      test(
        'should throw exception if points are lower than 0',
        () {
          Object? exception;
          try {
