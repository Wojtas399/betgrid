...
void main() {
  ...
  ThemeCubit createCubit() => ThemeCubit(authRepository, userRepository);
  ...
  group('initialize, ', () {
    ...
    blocTest(
      ...
      verify: (_) {
        ...
        verify(() => userRepository.getById(loggedUserId)).called(1);
      },
    );
  ...
  group('changeThemeMode, ', () {
    ...
    blocTest(
      ...
      expect:
          () => [const ThemeState(), const ThemeState(themeMode: newThemeMode)],
      verify: (_) {
        verify(() => authRepository.loggedUserId$).called(2);
        verify(
          () => userRepository.updateData(
