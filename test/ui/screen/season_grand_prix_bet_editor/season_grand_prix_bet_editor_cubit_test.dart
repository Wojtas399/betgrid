  ...
  group('onDnfDriverRemoved', () {
    ...
    blocTest(
      ...
      expect:
          () => [
            state = state!.copyWith(
              raceForm: state!.raceForm.copyWith(dnfDrivers: [allDrivers.last]),
            ),
          ],
    );
  });
