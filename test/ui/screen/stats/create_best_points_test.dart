...
void main() {
  ...
  test('grouped, '
      'should emit best stats for all players', () async {
    ...
    final List<PlayerStats> allPlayerStats = [
      ...
      PlayerStats(
        ...
        pointsForDrivers: [
          const PlayerStatsPointsForDriver(seasonDriverId: 'sd1', points: 1.11),
          const PlayerStatsPointsForDriver(
            seasonDriverId: 'sd2',
            points: 120.22,
          ),
          const PlayerStatsPointsForDriver(seasonDriverId: 'sd3', points: 3.33),
        ],
      ),
    ];
    final SeasonGrandPrix sgp1 =
        SeasonGrandPrixCreator(id: 'sgp1', grandPrixId: 'gp1').create();
    final SeasonGrandPrix sgp2 =
        SeasonGrandPrixCreator(id: 'sgp2', grandPrixId: 'gp2').create();
    final SeasonGrandPrix sgp3 =
        SeasonGrandPrixCreator(id: 'sgp3', grandPrixId: 'gp3').create();
    final SeasonDriver sd3 =
        const SeasonDriverCreator(id: 'sd3', driverId: 'd3').create();
    final GrandPrixBasicInfo gp1 =
        const GrandPrixBasicInfoCreator(
          id: 'gp1',
          name: 'Grand Prix 1',
        ).create();
    final GrandPrixBasicInfo gp2 =
        const GrandPrixBasicInfoCreator(
          id: 'gp2',
          name: 'Grand Prix 2',
        ).create();
    final GrandPrixBasicInfo gp3 =
        const GrandPrixBasicInfoCreator(
          id: 'gp3',
          name: 'Grand Prix 3',
        ).create();
  ...
  test('individual, '
      'should emit best stats for logged user', () async {
    const StatsType statsType = StatsType.individual;
    const int season = 2025;
    const String loggedUserId = 'u1';
    final Player loggedUser =
        const PlayerCreator(id: loggedUserId, username: 'logged user').create();
    const PlayerStats loggedUserStats = PlayerStats(
      ...
      pointsForDrivers: [
        PlayerStatsPointsForDriver(seasonDriverId: 'sd1', points: 30.11),
        PlayerStatsPointsForDriver(seasonDriverId: 'sd2', points: 20.22),
        PlayerStatsPointsForDriver(seasonDriverId: 'sd3', points: 10.33),
      ],
    );
    final SeasonGrandPrix sgp1 =
        SeasonGrandPrixCreator(id: 'sgp1', grandPrixId: 'gp1').create();
    ...
    final SeasonGrandPrix sgp3 =
        SeasonGrandPrixCreator(id: 'sgp3', grandPrixId: 'gp3').create();
    final SeasonDriver sd1 =
        const SeasonDriverCreator(id: 'sd1', driverId: 'd1').create();
    final GrandPrixBasicInfo gp1 =
        const GrandPrixBasicInfoCreator(
          id: 'gp1',
          name: 'Grand Prix 1',
    ...
    final individualBestPoints$ = create(statsType: statsType, season: season);
